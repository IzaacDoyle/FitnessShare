...
import doyle.izaac.fitnessshare.firebase.Logout
import doyle.izaac.fitnessshare.firebase.getCurrentUser
 ...
 */
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_account, R.id.nav_Fitness
            ), drawerLayout
        )
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            R.id.action_logout-> {
                ...
                intent.putExtra("LogOut","Logged Out")
    ...
    override fun onSupportNavigateUp(): Boolean {
        //add to here if you want to add to the nav menu
      //  val user = intent.getStringExtra("user_id")
      //  val useremail = intent.getStringExtra("email")
       val useremail = user!!.email
        val navController = findNavController(R.id.nav_host_fragment_content_main)
        nav_header_email.text = useremail
